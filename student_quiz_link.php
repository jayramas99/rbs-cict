...
<br>
	<img id="avatar" src="admin/<?php echo $row['location']; ?>" class="img-polaroid" style="margin-left:100px;">
		...
		<li class=""><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-chevron-left"></i>&nbsp;Back</a></li>
				...
				<li class=""><a href="downloadable_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Reviewer</a></li>

				<li class="active"><a href="student_quiz_list.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-reorder"></i>&nbsp;Review Assessment</a></li>
			</ul>
