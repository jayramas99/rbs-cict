...
<br>
	<img id="avatar" src="admin/<?php echo $row['location']; ?>" class="img-polaroid" style="margin-left:100px;">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class=""><a href="downloadable.php<?php echo '?id='.$get_id; ?>">	<i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Downloadable Materials</a></li>

				<li class="active"><a href="class_quiz.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Exam Grades</a></li>
			</ul>
