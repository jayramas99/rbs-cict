                ...
                <div class="span9" id="content" style="margin-left:400px;">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header"style="background-color:#f59d1f;font-size:25px;color:#4c4c4c;"> <br>
							<?php
										$query = mysqli_query($conn,"select * FROM quiz where teacher_id = '$session_id' and quiz_id ='$get_id'  order by date_added DESC ")or die(mysqli_error());
                            while ($row = mysqli_fetch_array($query)) {
	                            $id = $row['quiz_id'];
                            ?>   
							<b><?php  echo $row['quiz_description']; ?></b>
