   <div class="row-fluid" style="width:32vh;">
       <a href="teachers.php" class="btn btn-info"> Back</a>
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header" style="background-color:#f59d1f;">
                                <div class="muted pull-left"style="color:#4c4c4c;font-size:20px"><b>Edit Professors</b></div>
                            </div>
