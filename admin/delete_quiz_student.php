...
$query_quiz1 = mysqli_query($conn,"select * from class_quiz_main where quiz_id = '$id'")or die(mysqli_error());
                                        ...
                                        $result = mysqli_query($conn,"DELETE FROM student_class_quiz_main where class_quiz_id='$id_quiz1'");
                                        }
                                    }

$result2 = mysqli_query($conn,"DELETE FROM class_quiz_main where quiz_id='$id'");

header("location: students_assessments.php");
