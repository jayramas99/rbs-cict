  <div class="navbar navbar-fixed-top navbar-inverse" >
            <div class="navbar-inner " >
                <div class="container-fluid" style="background-color:#f59d1f;">
					...
					<b style="font-size:16px;color:#4c4c4c;"> 
                    ...
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Hello <?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i>
