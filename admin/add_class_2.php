						<!-- block -->
                        <div class="block" style="position:absolute;margin-left:600px;">
                            <div class="navbar navbar-inner block-header" style="background-color:#f59d1f;">
                                <div id="" class="muted pull-left"><h4 style="color:black;">Add class</h4></div>
                            </div>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="teacher_id"  class="" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($conn,"select * from teacher order by teacher_id");
											while($row = mysqli_fetch_array($query)){
