...
<br>
                    ...
                    <li> 
                        ...
                        <li >
                            <a href="students_assessments.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>Students Assessments</a>
                        </li>
                        
						<li>
                            <a href="teachers.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>Professors</a>
                        </li>
                        <li class="active">
                            <a href="add_class_teacher.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>Add Class</a>
                        </li>
