                ...
                <div class="span9" id="content" style="margin-left:400px;">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<p style="font-size:30px;color:#4c4c4c;margin-top:20px;">Review Assessment</p>
                            </div>
                                ...
                                <div class="span12">
									...
									?>                              
										...
										<?php if (empty($row1['grade'])){ ?>
											<a  data-placement="bottom" title="Take This Quiz" id="<?php echo $id; ?>Download" href="take_test.php<?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&<?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'quiz_time='.$quiz_time;	 ?>"><i class="icon-check icon-large"></i> Take Review Assessment</a>
										<?php } 
										elseif($row1['trys'] != 0)
										{
										...
										<?php }else{ ?>
										<b>Already Taken Score <?php echo $row1['grade']; ?></b>
										<?php } ?>
										</td>            
