...
<br>
		...
		<li class="">
				<a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class
				</a>
			</li>
		<li class="active">
			...
			<li ><a href="student_assessment.php"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;Assessments</a></li>
