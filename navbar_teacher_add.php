...
<img id="avatar" class="img-polaroid" src="admin/<?php echo $row['location']; ?>" style="margin-left:100px;">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class="active"><a href="add_class_teacher.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add Class</a></li>
		<li class=""><a href="teacher_quiz.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Create Exam</a></li>
		<li ><a href="general.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;General Statistics</a></li>
	</ul>
